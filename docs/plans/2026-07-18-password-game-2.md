...
| 6   | `digit-sum`          | act1     | "The digits in your password must sum to N."                               | N = rangeInt(rng, 20, 32); sum of all digit chars === N                                                                                          |
...
| 15  | `max-length-40`      | act3     | "Your password must be at most 40 characters. This is a security measure." | `[...password].length <= 40`                                                                                                                     |
