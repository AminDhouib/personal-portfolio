...
export interface CosmeticDef {
  ...
  unlockCondition?:
    | "always"
    | { stat: "totalAsteroidsDestroyed" | "totalDistance" | "totalRunsPlayed"; atLeast: number };
}
...
export const COSMETICS: CosmeticDef[] = [
  ...
  { id: "hull-nebula", slot: "hull", label: "Nebula Purple", cost: 250, value: "#9333ea" },
  {
    ...
    cost: 500,
    value: "#f59e0b",
    unlockCondition: { stat: "totalAsteroidsDestroyed", atLeast: 500 },
  },
  {
    id: "hull-phantom-black",
    slot: "hull",
    label: "Void Black",
    cost: 1000,
    value: "#0a0a0a",
    unlockCondition: { stat: "totalDistance", atLeast: 10000 },
  },
  ...
  { id: "engine-green", slot: "engine", label: "Green Cell", cost: 150, value: "#22c55e" },
  {
    ...
    cost: 300,
    value: "#ffffff",
    unlockCondition: { stat: "totalRunsPlayed", atLeast: 10 },
  },
