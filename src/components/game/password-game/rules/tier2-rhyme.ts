...
const RHYMES: readonly RhymeGroup[] = [
  {
    prompt: "cat",
    rhymes: ["bat", "hat", "mat", "rat", "sat", "fat", "pat", "vat", "flat", "chat"],
  },
  {
    prompt: "fight",
    rhymes: [
  ...
  {
    prompt: "sing",
    rhymes: ["ring", "king", "wing", "thing", "bring", "spring", "sting", "string", "fling"],
  },
  {
    prompt: "door",
    rhymes: ["more", "four", "score", "store", "shore", "pour", "core", "bore", "chore", "wore"],
  },
  {
    prompt: "sky",
    rhymes: ["fly", "cry", "dry", "try", "shy", "pie", "tie", "why", "high", "lie"],
  },
  {
    prompt: "snake",
    rhymes: ["bake", "cake", "lake", "make", "rake", "take", "shake", "stake", "wake"],
  },
  {
    prompt: "bone",
    rhymes: [
  ...
  {
    prompt: "tree",
    rhymes: ["bee", "knee", "free", "flee", "sea", "agree", "three", "me", "key", "plea"],
  },
  {
    prompt: "rock",
    rhymes: ["lock", "sock", "dock", "block", "clock", "flock", "knock", "shock", "talk", "walk"],
  },
];
